...
exports.createWrapper = exports.STOREKEY = exports.HYDRATE = void 0;
...
var getStoreKey = function (_a) {
    var _b = _a === void 0 ? {} : _a, storeKey = _b.storeKey;
    ...
    var withRedux = function (Component) {
        ...
        return _a = /** @class */ (function (_super) {
                ...
                Wrapper.prototype.hydrate = function (_a, context) {
                    ...
                    if (!this.store) {
                        this.store = initStore({ makeStore: makeStore, config: config, context: context });
                        if (config.debug)
